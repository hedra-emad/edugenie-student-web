...
export default function SocialLogin({ onGoogle }: SocialLoginProps) {
  return (
    <div className="flex justify-center">
      <button
        type="button"
        onClick={onGoogle}
        className="w-full flex  items-center justify-center px-4 py-2.5 border border-gray-200 rounded-2xl shadow-sm bg-white text-sm font-medium text-text-primary hover:bg-gray-50 hover:shadow hover:border-gray-300 transform transition-all duration-200 hover:-translate-y-[1px] active:translate-y-[0px] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
      >
