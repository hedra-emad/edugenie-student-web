...
export default function AuthSidebar() {
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-sidebar-bg via-[#112240] to-sidebar-bg text-white h-full w-full flex flex-col items-center justify-center p-8 sm:p-10">
      {/* Top glow effect */}
      ...
      <div className="flex-grow flex flex-col justify-center items-center text-center w-full z-10 relative">
        {/* Logo */}
        <div className="w-64 h-32 relative mb-8 group">
        ...
        <div className="space-y-6 max-w-sm">
          <p className="text-secondary font-medium text-xs tracking-[0.25em] uppercase">Intelligent Learning Ecosystem</p>
          ...
          <p className="text-blue-100/70 text-sm leading-relaxed mx-auto font-light mb-8">
      ...
      {/* Bottom faint text */}
      <p className="mt-8 text-[10px] text-white/30 tracking-widest font-bold uppercase z-10">
