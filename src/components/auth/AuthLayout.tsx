...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="auth-page min-h-screen flex flex-col bg-gradient-to-br from-background-page to-blue-50/50 relative">
     ...
     <main className="flex-1 flex w-full px-4 py-3 sm:px-6 z-10">
        <div className="w-full max-w-[1000px] m-auto bg-white/90 backdrop-blur-sm rounded-2xl shadow-layout flex flex-col lg:flex-row overflow-hidden border border-white/50">
          ...
          {/* Right Panel */}
          <div className="auth-right-panel w-full lg:w-[50%] relative overflow-hidden bg-white">
